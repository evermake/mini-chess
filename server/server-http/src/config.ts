...
export default () => {
  ...
  const GAME_HTTP_AUTHORIZATION_EXPIRES_IN_MINUTES = Number(process.env.GAME_HTTP_AUTHORIZATION_EXPIRES_IN_MINUTES)
  const GAME_HTTP_BOT_INVITATION_PREFIX = process.env.GAME_HTTP_BOT_INVITATION_PREFIX
